...
import static dk.sdu.macl.common.data.GameKeys.LEFT;
import static dk.sdu.macl.common.data.GameKeys.RIGHT;
import static dk.sdu.macl.common.data.GameKeys.UP;

import dk.sdu.macl.common.data.GameKeys;
...
public class PlayerControlSystem implements IEntityProcessingService {
    ...
    public void process(GameData gameData, World world) {
        ...
        for (Entity player : world.getEntities(Player.class)) {
            ...
            if (lifePart.isIsHit()) world.removeEntity(player);
